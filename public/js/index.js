...
$.ajax({
    ...
    success: function(response){
        ...
        if (data.error) {
            ...
            messageOne.textContent = "The weather data is printed below"
        }
        document.getElementById('result').textContent = `${JSON.stringify(data.weather.current, undefined, 4)}`;
    }
})
